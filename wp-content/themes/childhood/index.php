...
<div class="mainslider glide">
  <div class="glide__track" data-glide-el="track">
    <ul class="glide__slides">
      <li style="background-image: url('<?= bloginfo(
          'template_url'
    ...
    <div class="row">
      ...
      <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
        ...
        <div class="about__text">
          Наша компания уже больше десяти лет дарит позитивные эмоции детям и их родителям. Мы воплощаем все детские
          мечты и помогаем родителям дарить счастливое детство!
          <br> <br>
          Но и взрослые иногда так нуждаются в детских эмоциях! Мы можем и это, ведь так приятно почувствовать заботу
          даже когда тебе за... :)
        </div>
        <a href="#" class="button">Узнать больше</a>
      </div>
    ...
    <div class="toys__wrapper">
      ...
      <div class="toys__item" style="background-image: url(<?= bloginfo(
        ...
        <div class="toys__item-info">
          ...
          <div class="toys__item-descr">
            Кстати, у нас большой выбор игрушек, позу которых выбирает сам ребенок. (Долговечные. Ноги-руки не
            отламываются)
          </div>
          <div class="minibutton toys__trigger">Подробнее</div>
        </div>
      ...
      <div class="toys__item" style="background-image: url(<?= bloginfo(
        ...
        <div class="toys__item-info">
          ...
          <div class="toys__item-descr">
            Ваш ребенок без ума от персонажа мультика? Мы следим за всеми трендами и рады предложить как самых
            современных, так и персонажей "из нашего детства"
          </div>
          <div class="minibutton toys__trigger">Подробнее</div>
        </div>
      </div>
      <div class="toys__item" style="background-image: url(<?= bloginfo(
        ...
        <div class="toys__item-info">
          ...
          <div class="toys__item-descr">
            Хотите, чтобы вашему ребенку все завидовали? Подарите игрушки нашего собственного производства! Они
            уникальны и ваш ребенок будет гордым обладателем эксклюзива!
          </div>
          <div class="minibutton toys__trigger">Подробнее</div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        ...
        <form action="#" class="contacts__feed">
          ...
          <svg class="confirm ldt-bounce-in" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
            ...
            viewBox="0 0 448.8 448.8" style="enable-background:new 0 0 448.8 448.8; color: green" xml:space="preserve">
            <g>
              <g>
                <polygon fill="green"
